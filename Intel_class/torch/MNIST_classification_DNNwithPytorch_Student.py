...
def train_model(model, train_loader, val_loader, test_loader, num_epochs=15):
    ...
    for epoch in range(num_epochs):
        ...
        val_accuracy = test_model(model, val_loader, verbose=False)
        ...
        print(f'  Val Acc: {val_accuracy:.2f}, test Acc: {test_accuracy:.2f}%')
        print("-" * 60)
...
def main():
    ...
    train_losses, train_accs, val_accs, test_accs,  = train_model(model, train_loader, val_loader, test_loader, num_epochs=15)
    ...
    plot_training_history(train_losses, train_accs, val_accs, test_accs)
