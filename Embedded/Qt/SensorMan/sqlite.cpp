...
void Sqlite::SqliteRecvDataSlot(QString strRecvData)
{
...
void Sqlite::on_pPBClearChart_clicked()
{
    pCDSLine->clear();
    pTempLine->clear();
    pHumiLine->clear();
...
void Sqlite::on_pPBsearchDB_clicked()
{
...
void Sqlite::on_pPBdeleteDB_clicked()
{
    QDateTime fromDateTime = ui->pDateTimeEditFrom->dateTime();
    QDateTime toDateTime = ui->pDateTimeEditTo->dateTime();
