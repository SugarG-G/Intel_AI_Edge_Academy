...
void MatOp2()
{
    Mat img1 = imread("opencv_gilbut\\MatOp\\dog.bmp");
...
void MatOp3()
{
    Mat img1 = imread("opencv_gilbut\\MatOp\\cat.bmp");
...
void MatOp5()
{
    Mat img1 = imread("opencv_gilbut\\MatOp\\lenna.bmp");
...
void MatOp7()
{
    Mat img1 = imread("opencv_gilbut\\MatOp\\lenna.bmp", IMREAD_GRAYSCALE);
